...
while (true){
	...
	pbf_press_dpad(DPAD_UP, 5, 125);
	pbf_press_button(BUTTON_A, 5, 160);
	pbf_press_button(BUTTON_A, 5, 160);
	pbf_press_button(BUTTON_A, 5, 25); // extra A press to make sure it makes it trough the dialog
	...
	pbf_press_button(BUTTON_A, 5, 480);
